/*
 *  Program Name:count.cpp
 *
 *  Created on: July 19, 2019
 *  Author: Zain Rajani
 *
 *  Program Statement: A program takes a file as an argument and
 *  counts the total number of lines. Lines are defined with new line character.
 *  Program usage is "count filename.txt". The output should be the line count.
 */

// Library Declaration for standard usage
